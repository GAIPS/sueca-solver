...
//            };
        ...
        private static void NewMethod(List<List<int>> playersHands, int card)
        {
            SuecaGame game = new SuecaGame(10, playersHands, (int)Suit.Clubs, new List<Move>(), 0, 0);
