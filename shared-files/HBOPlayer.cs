...
{
    public class HBOPlayer : ArtificialPlayer
    {
        //public InformationSet InfoSet;

        public HBOPlayer(int id, List<int> initialHand, int trumpCard, int trumpPlayerId)
            : base(id)
        {
        ...
        override public int Play()
        {
            ...
            else
            {
                ...
                //chosenCard = PIMC.Execute(_id, InfoSet, 3, new List<int> { 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000 });
            }
